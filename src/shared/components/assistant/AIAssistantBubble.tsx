...
export function AIAssistantBubble() {
  return (
    <button
      type="button"
      aria-label="Assistente Finance Pro, em breve"
      title="Assistente Finance Pro - em breve"
      className="group fixed bottom-[5.75rem] right-4 z-40 h-14 w-14 rounded-full border border-accent/70 bg-surface p-0.5 shadow-glow outline-none transition-transform duration-normal ease-[var(--ease-premium)] hover:-translate-y-0.5 hover:scale-105 active:scale-95 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background xl:bottom-8 xl:right-8 xl:h-16 xl:w-16"
    >
      <img
        src={assistantAvatar}
        alt=""
